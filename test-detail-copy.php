                ...
                <div class="page-content">
                    <div class="row page-row">
                        <div class="jobs-wrapper col-md-8 col-sm-7">           
                            ...
                            <!--//panel--> 
<form class="form-horizontal" action="test-result.php" method="post"> 
...
<input type="hidden" name="QuestionName[]" value="<?php echo $QuestionName; ?>">
</a> </h3>
...
<input type="radio" name="ans_<?php echo $pk_questionid;?>[]" id="ans_<?php echo $pk_questionid;?>" value="<?php echo $answer;?>"> <?php echo $answer; ?> <?php echo $correct_answer; ?>
<input type="text" name="cor_ans_<?php echo $pk_questionid;?>[]" value="<?php echo $correct_answer; ?>">


<input type="text" name="ans_<?php echo $pk_questionid;?>[]" value="<?php echo $pk_questionid; ?>">
