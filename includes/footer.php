 <footer class="footer">
                        ...
                        <div class="row">
                            <p class="adr clearfix col-md-12 col-sm-4">
                                ...
                                <span class="adr-group pull-left">       
                                    <span class="street-address">Efreelearn</span><br>
                                    <span class="region">Nethaji Colony Velachery</span><br>
                                    <span class="postal-code">600042</span><br>
                                    <span class="country-name">INDIA</span>
                                </span>
                            </p>
                            <p class="tel col-md-12 col-sm-4"><i class="fa fa-phone"></i>Contact No will be updated soon</p>
                            <p class="email col-md-12 col-sm-4"><i class="fa fa-envelope"></i><a href="#">EMail will be updated soon</a></p>  
                        </div> 
                    </div><!--//footer-col-inner-->            
                </div><!--//foooter-col-->   
                </div>   
        ...
        <div class="bottom-bar">
            <div class="container">
                <div class="row">
                    <small class="copyright col-md-6 col-sm-12 col-xs-12">Copyright @ 2015 Efreelearn.com | Developed by <a href="#">Efreelearn Team</a></small>
